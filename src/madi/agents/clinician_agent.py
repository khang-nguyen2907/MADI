...
class ClinicianAgent:
    ...
    def create_system_prompt(self) -> str:
        ...
        configuration_json = {
            ...
            "response_format": clinician_agent_json_format
        }
        ...
        You are allowed to ask for additional medical documents if needed. 
        Configuration, instructions are provided in JSON format below:
        {json.dumps(configuration_json, indent=2)}
        Always respond with a JSON object following the response_format schema above.
        Remember to ask for additioal medical documents when the given ones are not strongly sufficient to diagnose"""
